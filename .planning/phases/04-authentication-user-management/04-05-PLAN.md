...
must_haves:
  ...
  artifacts:
    ...
    - path: "src/models/oauth_attempt.py"
      provides: "OAuth attempt logging"
...
from src.auth import auth_bp, registration_bp
from src.auth.oauth import oauth_bp
from src.billing import billing_bp, webhooks_bp
```
...
```
  ...
  <verify>
Run `python -c "from src.auth import oauth_bp, auth_bp, registration_bp; print('All blueprints exported')"` succeeds.
  </verify>
