...
Copy this file to `.claude/SESSION_PRIMER_<phase>-<task>.md` and fill in before each session.
Paste the filled primer as the first message in Claude Code.
...
<Pick one. See CLAUDE.md Task Mode table.>
```
