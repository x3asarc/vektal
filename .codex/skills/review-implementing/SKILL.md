...
description: Use when user wants to Use before implementing any plan or spec. Evaluate implementation plans against requirements, surface gaps, ambiguities, or risks before a single line of code is written.
---
